...
describe('should support Switch', function() {
  it('has a prefix of 4903 and a length of 16', function () {
    detectNetwork('4903123456780123').should.equal('Switch')
  });
  it('has a prefix of 4905 and a length of 16', function () {
    detectNetwork('4905123456780123').should.equal('Switch')
  });
  it('has a prefix of 4911 and a length of 16', function () {
    detectNetwork('4911123456780123').should.equal('Switch')
  });
  it('has a prefix of 4936 and a length of 16', function () {
    detectNetwork('4936123456780123').should.equal('Switch')
  });
  it('has a prefix of 564182 and a length of 16', function () {
    detectNetwork('5641821234567801').should.equal('Switch')
  });
  it('has a prefix of 633110 and a length of 16', function () {
    detectNetwork('6331101234567801').should.equal('Switch')
  });
  it('has a prefix of 6333 and a length of 16', function () {
    detectNetwork('6333123456780123').should.equal('Switch')
  });
  it('has a prefix of 6759 and a length of 16', function () {
    detectNetwork('6759123456780123').should.equal('Switch')
  });

  it('has a prefix of 4903 and a length of 18', function () {
    detectNetwork('490312345678012345').should.equal('Switch')
  });
  it('has a prefix of 4905 and a length of 18', function () {
    detectNetwork('490512345678012345').should.equal('Switch')
  });
  it('has a prefix of 4911 and a length of 18', function () {
    detectNetwork('491112345678012345').should.equal('Switch')
  });
  it('has a prefix of 4936 and a length of 18', function () {
    detectNetwork('493612345678012345').should.equal('Switch')
  });
  it('has a prefix of 564182 and a length of 18', function () {
    detectNetwork('564182123456780123').should.equal('Switch')
  });
  it('has a prefix of 633110 and a length of 18', function () {
    detectNetwork('633110123456780123').should.equal('Switch')
  });
  it('has a prefix of 6333 and a length of 18', function () {
    detectNetwork('633312345678012345').should.equal('Switch')
  });
  it('has a prefix of 6759 and a length of 18', function () {
    detectNetwork('675912345678012345').should.equal('Switch')
  });

  it('has a prefix of 4903 and a length of 19', function () {
    detectNetwork('4903123456780123456').should.equal('Switch')
  });
  it('has a prefix of 4905 and a length of 19', function () {
    detectNetwork('4905123456780123456').should.equal('Switch')
  });
  it('has a prefix of 4911 and a length of 19', function () {
    detectNetwork('4911123456780123456').should.equal('Switch')
  });
  it('has a prefix of 4936 and a length of 19', function () {
    detectNetwork('4936123456780123456').should.equal('Switch')
  });
  it('has a prefix of 633110 and a length of 19', function () {
    detectNetwork('6331101234567801234').should.equal('Switch')
  });
  it('has a prefix of 564182 and a length of 19', function () {
    detectNetwork('5641821234567801234').should.equal('Switch')
  });
  it('has a prefix of 633110 and a length of 19', function () {
    detectNetwork('6331101234567801234').should.equal('Switch')
  });
  it('has a prefix of 6333 and a length of 19', function () {
    detectNetwork('6333123456780123456').should.equal('Switch')
  });
  it('has a prefix of 6759 and a length of 19', function () {
    detectNetwork('6759123456780123456').should.equal('Switch')
  });
